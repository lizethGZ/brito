...
<html lang="en">
    ...
    <body>
		...
		<ul class="tabs">
			<li><a href="#tab1"><span class=""></span><span class="tab-text">Proyectos</span></a></li>
			<li><a href="#tab2"><span class=""></span><span class="tab-text">Anteproyectos</span></a></li>
            <li><a href="#tab3"><span class=""></span><span class="tab-text">Solicitud de token</span></a></li>
            <li><a href="#tab4"><span class=""></span><span class="tab-text">Docentes</span></a></li>
            <li><a href="#tab5"><span class=""></span><span class="tab-text">Asesores</span></a></li>
            <li><a href="#tab6"><span class=""></span><span class="tab-text">Egresados</span></a></li>
            <li><a href="#tab7"><span class=""></span><span class="tab-text">Registrar</span></a></li>
            <li><a href="#tab8"><span class=""></span><span class="tab-text">Archivos</span></a></li>
		</ul>

		<div class="secciones">
			<article id="tab1">
            <p>Data grid proyectos</p>
            </article>
            <article id="tab2">
            <p>Data grid solicitud anteproyectos</p>
            </article>
            <article id="tab3">
            <p>Data grid solicitud de token</p>
            </article>
            <article id="tab4">
            <p>Data grid docentes</p>
            </article>
            <article id="tab5">
            <p>Data grid Asesores</p>
            </article>
            <article id="tab6">
            <p>Data grid egresados</p>
            </article>
            <article id="tab7">
            <div class="row">
                <div class="col-sm-4">
